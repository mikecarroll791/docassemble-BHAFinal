...
setup(name='docassemble.BHAFinal',
      version='0.0.1',
      description=('A docassemble extension.'),
      long_description='# docassemble.BHAFinal\n\nA docassemble extension.\n\n## Author\n\nmcarroll11@su.suffolk.edu\n\n',
      ...
      zip_safe=False,
      package_data=find_package_data(where='docassemble/BHAFinal/', package='docassemble.BHAFinal'),
     )
